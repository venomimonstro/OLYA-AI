...
def main() -> int:
    ...
    parser.add_argument('--website-limit', type=int, default=3000)
    ...
    if not args.skip_web:
        if _run([python, '-m', 'scripts.seed_business_websites', '--limit', str(max(1,args.website_limit))]) != 0:
        ...
        if _run([
            ...
            '--limit', str(max(1,args.crawl_limit)),
