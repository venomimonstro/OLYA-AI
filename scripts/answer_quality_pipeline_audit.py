...
def main() -> int:
    ...
    _require(context, ("build_answer_contract", "X1 ANSWER CONTRACT"), "context compiler")
    ...
    _require(quality, ("_server_evidence_context", "current_task_solver_context", "unsupported_claim", "contradiction", "stale_claim", "bad_inference", "_quality_clip", "EVIDENCE"), "evidence-aware critic")
    ...
    _require(tests, ("test_user_source_lookalike_cannot_become_critic_evidence", "test_server_task_solver_context_is_available_to_evidence_critic", "test_consequential_recommendation_gets_critic_and_conditional_repair_budget", "test_critic_is_evidence_aware"), "quality tests")
