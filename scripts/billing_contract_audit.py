...
def audit()->dict:
    ...
    return {"format":"x1-billing-contract-audit-v2","status":"passed" if not errors else "failed","required_routes":[{"method":m,"path":p} for m,p in sorted(REQUIRED)],"request_unit_billing":True,"errors":errors}
