...
def workspace() -> HTMLResponse:
    ...
    new_account = '<section class="view" id="view-account"><div class="content"><h1>Аккаунт и тариф</h1><p class="lead">Профиль, текущий план, прозрачное потребление и управление подпиской без скрытых списаний.</p><div class="cards"><div class="card"><h2>Профиль</h2><div id="account-profile" class="muted">Загружаю…</div></div><div class="card"><h2>Подписка</h2><div id="account-subscription" class="muted">Загружаю…</div><div class="formrow"><button class="secondary" id="subscription-cancel" disabled>Отключить продление</button><button class="secondary" id="subscription-resume" disabled>Возобновить</button></div></div><div class="card"><h2>Вычислительный бюджет</h2><div id="account-budget" class="muted">Загружаю…</div></div><div class="card"><h2>Измеренный ресурс</h2><div id="account-commerce-usage" class="muted">Загружаю…</div><progress class="account-progress" id="account-resource-progress" value="0" max="100"></progress></div></div><div class="account-section"><h2>Тарифы</h2><p class="muted">Цены и лимиты загружаются с сервера. Браузер не передаёт сумму или валюту оплаты.</p><div class="cards" id="account-plans"></div><div class="billing-state" id="billing-state"></div></div><div class="account-section cards"><div class="card"><h2>Последние checkout</h2><div class="billing-list" id="account-checkouts"></div></div><div class="card"><h2>Платежи</h2><div class="billing-list" id="account-payments"></div></div></div><div class="formrow"><button class="secondary" id="account-export">Экспортировать мои данные</button><button class="secondary" id="onboarding-open">Начало работы</button></div></div></section>'
