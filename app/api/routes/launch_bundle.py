...
from app.api.routes.tester_admin import router as tester_admin_router
...
from app.tester_admin_ui import router as tester_admin_ui_router
...
router.include_router(tester_admin_router)
...
router.include_router(tester_admin_ui_router)
