...
from app.services.chat_runtime_recovery import install_dead_job_recovery


# smart_chat imports chat_runtime before this module, so installation here avoids
# circular imports while ensuring every smart-chat process gets stale-job recovery.
install_dead_job_recovery()
    ...
    return [
        ChatMessage(
            ...
            content=(
                ...
                "Стиль: спокойный, уверенный, интеллектуальный, без шаблонного тона. Предпочитай цельные абзацы и естественные переходы; списки используй только когда они реально улучшают ясность. "
                "Не соглашайся автоматически с предпосылкой пользователя: если она слабая или спорная, аккуратно укажи это и предложи более сильную формулировку/вариант. "
                "Для анализа/решения: прямой вывод, аргументы, альтернативы, риски/компромиссы, условия смены вывода и конкретный следующий шаг. "
