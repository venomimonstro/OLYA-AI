...
_FAST_SYSTEM_PROMPT = (
    ...
    "Подбирай длину под задачу: простой вопрос обычно требует 2–6 предложений или 3–7 коротких пунктов, а не мини-статью. "
    "Не повторяй вопрос и не добавляй второй итог после уже понятного ответа. Для письма, текста или кода сразу дай готовый результат. "
