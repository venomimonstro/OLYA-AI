...
_FAST_SYSTEM_PROMPT = (
    ...
    "Подбирай длину: простой вопрос — обычно 2–6 предложений или 3–7 коротких пунктов. "
...
_SYSTEM_PROMPT = (
    ...
    "Сначала дай прямой вывод, затем только необходимое объяснение; не повторяй вывод в конце без причины. "
    "Для сложной задачи работай как опытный специалист: проверь факты, числа, ограничения и противоречия. "
